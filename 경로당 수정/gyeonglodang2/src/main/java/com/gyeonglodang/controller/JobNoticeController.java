...
public class JobNoticeController {
	...
	public String jobNotice_board(
		...
		// get 방식으로 idx를 가져오는 경우 삭제 매서드 실행
	...
	// jobNotice_board_new.jsp에서 기본정보 저장 메서드 *231110 권지현
	// JobNoticeDto와 JobNoticeRecListDto
	...
	// jobNotice_board_new.jsp에서 기본정보 업데이트 메서드 *231110 권지현
